...
// Fetch new rules from the server at most twice a day.
const FETCH_INTERVAL_SECS = 60 * 60 * 12;
...
function compile(rulesets) {
  ...
  // Clone rules to not modify storage contents.
  rulesets = Cu.cloneInto(rulesets, {});
