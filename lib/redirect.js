...
// List of temporarily blocked hosts.
...
function onModifyRequest({subject: channel}) {
  ...
  // Ignore temporary blocked hosts. This helps with pages redirecting
  ...
  // Ignore requests from this hosts for the next few seconds.
  blockedHosts.add(host);
  setTimeout(() => blockedHosts.delete(host), UNBLOCK_TIMEOUT);
}
